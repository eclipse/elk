 ...
 * {@link #onRoot()}option can just be used, if it is supported by the layout algorithm. This annotation can be used
 * more then once per class or method.
 */
@Retention(RetentionPolicy.RUNTIME)
@Target({ ElementType.TYPE, ElementType.METHOD })
@Inherited
@Repeatable(RunBeforeProcessors.class)
public @interface RunBeforeProcessor {
