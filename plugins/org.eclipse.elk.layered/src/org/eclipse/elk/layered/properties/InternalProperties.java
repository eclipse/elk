...
import org.eclipse.elk.layered.compound.CrossHierarchyEdge;
...
import org.eclipse.elk.layered.p3order.NodeGroup;
import org.eclipse.elk.layered.p5edges.splines.ConnectedSelfLoopComponent;
import org.eclipse.elk.layered.p5edges.splines.LoopSide;
...
public final class InternalProperties {
     ...
     * {@link org.eclipse.elk.layered.intermediate.InLayerConstraintProcessor}.
     */
    ...
    public static final IProperty<List<LLabel>> BIGNODES_ORIG_LABELS = new Property<List<LLabel>>(
            "org.eclipse.elk.layered.bigNodeLabels", new ArrayList<LLabel>());
    ...
    public static final IProperty<Function<Void, Void>> BIGNODES_POST_PROCESS =
            new Property<Function<Void, Void>>("org.eclipse.elk.layered.postProcess", null);
