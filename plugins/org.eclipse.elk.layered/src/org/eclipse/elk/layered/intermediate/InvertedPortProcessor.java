 ...
 * {@link org.eclipse.elk.layered.properties.Properties#NODE_TYPE} property. They are treated
 * just like ordinary {@link org.eclipse.elk.layered.properties.NodeType#LONG_EDGE} dummy
 * nodes
 * </p>
 * 
 * <p>
...
public final class InvertedPortProcessor implements ILayoutProcessor {
    ...
    /**
     * Properly sets the
     * {@link org.eclipse.elk.layered.properties.Properties#LONG_EDGE_SOURCE} and
     * {@link org.eclipse.elk.layered.properties.Properties#LONG_EDGE_TARGET} properties for
     * the given long edge dummy. This is required for the
     * {@link org.eclipse.elk.layered.intermediate.HyperedgeDummyMerger} to work correctly.
     * 
     * @param longEdgeDummy
