 ...
 *******************************************************************************/
package org.eclipse.elk.core.meta.serializer;
...
public class MetaDataSyntacticSequencer extends AbstractSyntacticSequencer {

	protected MetaDataGrammarAccess grammarAccess;
	protected AbstractElementAlias match_MdBundle___BundleKeyword_1_0_LeftCurlyBracketKeyword_1_1_RightCurlyBracketKeyword_1_3__q;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (MetaDataGrammarAccess) access;
		match_MdBundle___BundleKeyword_1_0_LeftCurlyBracketKeyword_1_1_RightCurlyBracketKeyword_1_3__q = new GroupAlias(false, true, new TokenAlias(false, false, grammarAccess.getMdBundleAccess().getBundleKeyword_1_0()), new TokenAlias(false, false, grammarAccess.getMdBundleAccess().getLeftCurlyBracketKeyword_1_1()), new TokenAlias(false, false, grammarAccess.getMdBundleAccess().getRightCurlyBracketKeyword_1_3()));
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			if (match_MdBundle___BundleKeyword_1_0_LeftCurlyBracketKeyword_1_1_RightCurlyBracketKeyword_1_3__q.equals(syntax))
				emit_MdBundle___BundleKeyword_1_0_LeftCurlyBracketKeyword_1_1_RightCurlyBracketKeyword_1_3__q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 *     (rule start) (ambiguity) members+=MdBundleMember
	 */
	protected void emit_MdBundle___BundleKeyword_1_0_LeftCurlyBracketKeyword_1_1_RightCurlyBracketKeyword_1_3__q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
