...
public class CrossingsCounterTest extends InLayerEdgeTestGraphCreator {
	...
	@Test
	public void countInLayerCrossingsOnBothSides_ignoresCrossingsWhenPortOrderNotSetNoEdgeBetweenUpperAndLowerLowerUpsideDown() {
	...
	@Test
	public void countInLayerCrossingsOnBothSides_givenMultipleInBetweenLayerEdgesIntoNodeWithNoFixedPortOrder_CountsNoCrossings() {
	...
	@Test
	public void countInLayerCrossingsOnBothSides_givenMultipleInBetweenLayerEdgesIntoNodeWithNoFixedPortOrder_CountsCrossings() {
	...
	public void countCrossingsBetweenLayers_fixedPortOrderCrossingOnTwoNodes() {
		LNode left = addNodeToLayer(makeLayer(graph));
		LNode right = addNodeToLayer(makeLayer(graph));
