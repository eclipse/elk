 ...
 *******************************************************************************/
package org.eclipse.elk.core.service.ui.util;
...
public abstract class EclipseMonitoredOperation extends MonitoredOperation {
     ...
     */
    public EclipseMonitoredOperation(final ExecutorService service) {
        this(service, null);
    }
    ...
    private void runOffscreen() {
        ...
        try {
            ...
            status.set(new Status(IStatus.ERROR, EclipseElkServicePlugin.PLUGIN_ID,
                        ...
                        public void run() {
                            try {
                                ...
                                status.set(new Status(IStatus.ERROR,
                                        EclipseElkServicePlugin.PLUGIN_ID,
                                        "Error in monitored operation", throwable));
                            }
                        }
                    });
    ...
    protected class CancelableProgressMonitor extends BasicProgressMonitor {
        ...
        @Override
        public boolean isCanceled() {
            return EclipseMonitoredOperation.this.isCanceled();
        }
