...
* generated by Xtext
*/
package org.eclipse.elk.graphviz.dot.services;
...
public class GraphvizDotGrammarAccess extends AbstractGrammarElementFinder {
	...
	private final EdgeOperatorElements unknownRuleEdgeOperator;
	...
	public GraphvizDotGrammarAccess(GrammarProvider grammarProvider,
		...
		this.unknownRuleEdgeOperator = new EdgeOperatorElements();
		...
		this.tPREC_LINE = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "PREC_LINE");
	}
	
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		Grammar grammar = grammarProvider.getGrammar(this);
		while (grammar != null) {
			if ("org.eclipse.elk.graphviz.dot.GraphvizDot".equals(grammar.getName())) {
				return grammar;
			}
	...
	public EdgeOperatorElements getEdgeOperatorAccess() {
		return unknownRuleEdgeOperator;
	}
