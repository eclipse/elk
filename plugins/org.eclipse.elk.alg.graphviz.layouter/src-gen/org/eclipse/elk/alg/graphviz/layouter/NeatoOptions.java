...
public class NeatoOptions implements ILayoutMetaDataProvider {
  /**
   * The id of the Neato algorithm.
   */
  public final static String ALGORITHM_ID = "org.eclipse.elk.graphviz.neato";
  ...
  public void apply(final org.eclipse.elk.core.data.ILayoutMetaDataProvider.Registry registry) {
    registry.register(new org.eclipse.elk.core.data.LayoutAlgorithmData(
        ...
        new org.eclipse.elk.core.util.AlgorithmFactory(GraphvizLayoutProvider.class, "NEATO"),
