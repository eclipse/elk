...
public class FdpOptions implements ILayoutMetaDataProvider {
  /**
   * The id of the Graphviz FDP algorithm.
   */
  public static final String ALGORITHM_ID = "org.eclipse.elk.graphviz.fdp";

  /**
   * Default value for {@link #PADDING} with algorithm "Graphviz FDP".
   */
  ...
  /**
   * Default value for {@link #SPACING_NODE_NODE} with algorithm "Graphviz FDP".
   */
  ...
  /**
   * Default value for {@link #EDGE_ROUTING} with algorithm "Graphviz FDP".
   */
  ...
  /**
   * Default value for {@link #SEPARATE_CONNECTED_COMPONENTS} with algorithm "Graphviz FDP".
   */
  ...
  /**
   * Default value for {@link #MAXITER} with algorithm "Graphviz FDP".
   */
  private static final int MAXITER_DEFAULT = 600;
   ...
   */
  public static class FdpFactory implements org.eclipse.elk.core.util.IFactory<AbstractLayoutProvider> {
    public AbstractLayoutProvider create() {
      AbstractLayoutProvider provider = new GraphvizLayoutProvider();
      provider.initialize("FDP");
      return provider;
    }
  ...
  public void apply(final org.eclipse.elk.core.data.ILayoutMetaDataProvider.Registry registry) {
    registry.register(new LayoutAlgorithmData.Builder()
        .id("org.eclipse.elk.graphviz.fdp")
        .name("Graphviz FDP")
        .description("Spring model layouts similar to those of Neato, but does this by reducing forces rather than working with energy. Fdp implements the Fruchterman-Reingold heuristic including a multigrid solver that handles larger graphs and clustered undirected graphs.")
        .providerFactory(new FdpFactory())
        .category("org.eclipse.elk.force")
        .melkBundleName("Graphviz")
        .definingBundleId("org.eclipse.elk.alg.graphviz.layouter")
        .imagePath("images/fdp_layout.png")
        .supportedFeatures(EnumSet.of(GraphFeature.SELF_LOOPS, GraphFeature.MULTI_EDGES, GraphFeature.EDGE_LABELS, GraphFeature.CLUSTERS))
        .create()
    );
