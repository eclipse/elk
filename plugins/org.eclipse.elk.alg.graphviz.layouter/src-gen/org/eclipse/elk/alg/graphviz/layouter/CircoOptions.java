...
public class CircoOptions implements ILayoutMetaDataProvider {
  /**
   * The id of the Graphviz Circo algorithm.
   */
  public static final String ALGORITHM_ID = "org.eclipse.elk.graphviz.circo";

  /**
   * Default value for {@link #PADDING} with algorithm "Graphviz Circo".
   */
  ...
  /**
   * Default value for {@link #SPACING_NODE_NODE} with algorithm "Graphviz Circo".
   */
  ...
  /**
   * Default value for {@link #EDGE_ROUTING} with algorithm "Graphviz Circo".
   */
  ...
  /**
   * Default value for {@link #SEPARATE_CONNECTED_COMPONENTS} with algorithm "Graphviz Circo".
   */
   ...
   */
  public static class CircoFactory implements org.eclipse.elk.core.util.IFactory<AbstractLayoutProvider> {
    public AbstractLayoutProvider create() {
      AbstractLayoutProvider provider = new GraphvizLayoutProvider();
      provider.initialize("CIRCO");
      return provider;
    }
