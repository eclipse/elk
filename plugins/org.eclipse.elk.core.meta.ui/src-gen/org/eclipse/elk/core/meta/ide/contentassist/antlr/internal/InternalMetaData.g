...
:
	(
		{ before(grammarAccess.getMdGroupAccess().getChildrenMdGroupOrOptionParserRuleCall_3_0()); }
		ruleMdGroupOrOption
		{ after(grammarAccess.getMdGroupAccess().getChildrenMdGroupOrOptionParserRuleCall_3_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
