		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getMdAlgorithmAccess().getGroup_8_4_3(), "rule__MdAlgorithm__Group_8_4_3__0");
					...
					put(grammarAccess.getMdPropertyAccess().getLabelAssignment_6_0_2(), "rule__MdProperty__LabelAssignment_6_0_2");
					put(grammarAccess.getMdPropertyAccess().getDescriptionAssignment_6_1_2(), "rule__MdProperty__DescriptionAssignment_6_1_2");
					...
					put(grammarAccess.getMdAlgorithmAccess().getLabelAssignment_8_0_2(), "rule__MdAlgorithm__LabelAssignment_8_0_2");
					put(grammarAccess.getMdAlgorithmAccess().getDescriptionAssignment_8_1_2(), "rule__MdAlgorithm__DescriptionAssignment_8_1_2");
					put(grammarAccess.getMdAlgorithmAccess().getCategoryAssignment_8_2_2(), "rule__MdAlgorithm__CategoryAssignment_8_2_2");
					put(grammarAccess.getMdAlgorithmAccess().getPreviewImageAssignment_8_3_2(), "rule__MdAlgorithm__PreviewImageAssignment_8_3_2");
					put(grammarAccess.getMdAlgorithmAccess().getSupportedFeaturesAssignment_8_4_2(), "rule__MdAlgorithm__SupportedFeaturesAssignment_8_4_2");
					put(grammarAccess.getMdAlgorithmAccess().getSupportedFeaturesAssignment_8_4_3_1(), "rule__MdAlgorithm__SupportedFeaturesAssignment_8_4_3_1");
					...
					put(grammarAccess.getMdCategoryAccess().getLabelAssignment_4_0_2(), "rule__MdCategory__LabelAssignment_4_0_2");
					put(grammarAccess.getMdCategoryAccess().getDescriptionAssignment_4_1_2(), "rule__MdCategory__DescriptionAssignment_4_1_2");
