		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getMdPropertyAccess().getGroup_6_4_2(), "rule__MdProperty__Group_6_4_2__0");
					put(grammarAccess.getMdPropertyAccess().getGroup_6_5(), "rule__MdProperty__Group_6_5__0");
					put(grammarAccess.getMdPropertyAccess().getGroup_6_5_2(), "rule__MdProperty__Group_6_5_2__0");
					...
					put(grammarAccess.getMdPropertyAccess().getTargetsAssignment_6_4_1(), "rule__MdProperty__TargetsAssignment_6_4_1");
					put(grammarAccess.getMdPropertyAccess().getTargetsAssignment_6_4_2_1(), "rule__MdProperty__TargetsAssignment_6_4_2_1");
					put(grammarAccess.getMdPropertyAccess().getLegacyIdsAssignment_6_5_1(), "rule__MdProperty__LegacyIdsAssignment_6_5_1");
					put(grammarAccess.getMdPropertyAccess().getLegacyIdsAssignment_6_5_2_1(), "rule__MdProperty__LegacyIdsAssignment_6_5_2_1");
