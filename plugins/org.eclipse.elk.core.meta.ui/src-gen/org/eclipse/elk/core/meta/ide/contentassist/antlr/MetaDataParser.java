...
public class MetaDataParser extends AbstractContentAssistParser {
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getMdGroupOrOptionAccess().getAlternatives(), "rule__MdGroupOrOption__Alternatives");
					put(grammarAccess.getMdOptionAccess().getAlternatives_1(), "rule__MdOption__Alternatives_1");
					...
					put(grammarAccess.getMdOptionTargetTypeAccess().getAlternatives(), "rule__MdOptionTargetType__Alternatives");
					put(grammarAccess.getMdGraphFeatureAccess().getAlternatives(), "rule__MdGraphFeature__Alternatives");
					put(grammarAccess.getMdModelAccess().getGroup(), "rule__MdModel__Group__0");
					put(grammarAccess.getMdBundleAccess().getGroup(), "rule__MdBundle__Group__0");
					...
					put(grammarAccess.getMdOptionAccess().getGroup_6_1(), "rule__MdOption__Group_6_1__0");
					put(grammarAccess.getMdOptionAccess().getGroup_6_2(), "rule__MdOption__Group_6_2__0");
					put(grammarAccess.getMdOptionAccess().getGroup_6_3(), "rule__MdOption__Group_6_3__0");
					put(grammarAccess.getMdOptionAccess().getGroup_6_4(), "rule__MdOption__Group_6_4__0");
					put(grammarAccess.getMdOptionAccess().getGroup_6_5(), "rule__MdOption__Group_6_5__0");
					put(grammarAccess.getMdOptionAccess().getGroup_6_6(), "rule__MdOption__Group_6_6__0");
					put(grammarAccess.getMdOptionAccess().getGroup_6_6_2(), "rule__MdOption__Group_6_6_2__0");
					put(grammarAccess.getMdOptionAccess().getGroup_6_7(), "rule__MdOption__Group_6_7__0");
					put(grammarAccess.getMdOptionAccess().getGroup_6_7_2(), "rule__MdOption__Group_6_7_2__0");
					put(grammarAccess.getMdOptionDependencyAccess().getGroup(), "rule__MdOptionDependency__Group__0");
					put(grammarAccess.getMdOptionDependencyAccess().getGroup_2(), "rule__MdOptionDependency__Group_2__0");
					put(grammarAccess.getMdAlgorithmAccess().getGroup(), "rule__MdAlgorithm__Group__0");
					put(grammarAccess.getMdAlgorithmAccess().getGroup_5(), "rule__MdAlgorithm__Group_5__0");
					put(grammarAccess.getMdAlgorithmAccess().getGroup_8_0(), "rule__MdAlgorithm__Group_8_0__0");
					put(grammarAccess.getMdAlgorithmAccess().getGroup_8_1(), "rule__MdAlgorithm__Group_8_1__0");
					put(grammarAccess.getMdAlgorithmAccess().getGroup_8_2(), "rule__MdAlgorithm__Group_8_2__0");
					put(grammarAccess.getMdAlgorithmAccess().getGroup_8_3(), "rule__MdAlgorithm__Group_8_3__0");
					put(grammarAccess.getMdAlgorithmAccess().getGroup_8_4(), "rule__MdAlgorithm__Group_8_4__0");
					...
					put(grammarAccess.getMdCategoryAccess().getGroup_4_2(), "rule__MdCategory__Group_4_2__0");
					put(grammarAccess.getMdOptionSupportAccess().getGroup(), "rule__MdOptionSupport__Group__0");
					put(grammarAccess.getMdOptionSupportAccess().getGroup_2(), "rule__MdOptionSupport__Group_2__0");
					put(grammarAccess.getMdOptionSupportAccess().getGroup_3(), "rule__MdOptionSupport__Group_3__0");
					...
					put(grammarAccess.getMdModelAccess().getNameAssignment_1(), "rule__MdModel__NameAssignment_1");
					put(grammarAccess.getMdModelAccess().getImportSectionAssignment_2(), "rule__MdModel__ImportSectionAssignment_2");
					put(grammarAccess.getMdModelAccess().getBundleAssignment_3(), "rule__MdModel__BundleAssignment_3");
					...
					put(grammarAccess.getMdOptionAccess().getOutputAssignment_1_2(), "rule__MdOption__OutputAssignment_1_2");
					put(grammarAccess.getMdOptionAccess().getGlobalAssignment_1_3(), "rule__MdOption__GlobalAssignment_1_3");
					put(grammarAccess.getMdOptionAccess().getNameAssignment_3(), "rule__MdOption__NameAssignment_3");
					put(grammarAccess.getMdOptionAccess().getTypeAssignment_4_1(), "rule__MdOption__TypeAssignment_4_1");
					put(grammarAccess.getMdOptionAccess().getLabelAssignment_6_0_1(), "rule__MdOption__LabelAssignment_6_0_1");
					put(grammarAccess.getMdOptionAccess().getDescriptionAssignment_6_1_1(), "rule__MdOption__DescriptionAssignment_6_1_1");
					put(grammarAccess.getMdOptionAccess().getDocumentationAssignment_6_2_1(), "rule__MdOption__DocumentationAssignment_6_2_1");
					put(grammarAccess.getMdOptionAccess().getDefaultValueAssignment_6_3_2(), "rule__MdOption__DefaultValueAssignment_6_3_2");
					put(grammarAccess.getMdOptionAccess().getLowerBoundAssignment_6_4_2(), "rule__MdOption__LowerBoundAssignment_6_4_2");
					put(grammarAccess.getMdOptionAccess().getUpperBoundAssignment_6_5_2(), "rule__MdOption__UpperBoundAssignment_6_5_2");
					put(grammarAccess.getMdOptionAccess().getTargetsAssignment_6_6_1(), "rule__MdOption__TargetsAssignment_6_6_1");
					put(grammarAccess.getMdOptionAccess().getTargetsAssignment_6_6_2_1(), "rule__MdOption__TargetsAssignment_6_6_2_1");
					put(grammarAccess.getMdOptionAccess().getLegacyIdsAssignment_6_7_1(), "rule__MdOption__LegacyIdsAssignment_6_7_1");
					put(grammarAccess.getMdOptionAccess().getLegacyIdsAssignment_6_7_2_1(), "rule__MdOption__LegacyIdsAssignment_6_7_2_1");
					put(grammarAccess.getMdOptionAccess().getDependenciesAssignment_7(), "rule__MdOption__DependenciesAssignment_7");
					put(grammarAccess.getMdOptionDependencyAccess().getTargetAssignment_1(), "rule__MdOptionDependency__TargetAssignment_1");
					put(grammarAccess.getMdOptionDependencyAccess().getValueAssignment_2_1(), "rule__MdOptionDependency__ValueAssignment_2_1");
					put(grammarAccess.getMdAlgorithmAccess().getDeprecatedAssignment_0(), "rule__MdAlgorithm__DeprecatedAssignment_0");
					put(grammarAccess.getMdAlgorithmAccess().getNameAssignment_2(), "rule__MdAlgorithm__NameAssignment_2");
					put(grammarAccess.getMdAlgorithmAccess().getProviderAssignment_4(), "rule__MdAlgorithm__ProviderAssignment_4");
					put(grammarAccess.getMdAlgorithmAccess().getParameterAssignment_5_1(), "rule__MdAlgorithm__ParameterAssignment_5_1");
					put(grammarAccess.getMdAlgorithmAccess().getLabelAssignment_8_0_1(), "rule__MdAlgorithm__LabelAssignment_8_0_1");
					put(grammarAccess.getMdAlgorithmAccess().getTargetClassAssignment_8_1_1(), "rule__MdAlgorithm__TargetClassAssignment_8_1_1");
					put(grammarAccess.getMdAlgorithmAccess().getDescriptionAssignment_8_2_1(), "rule__MdAlgorithm__DescriptionAssignment_8_2_1");
					put(grammarAccess.getMdAlgorithmAccess().getDocumentationAssignment_8_3_1(), "rule__MdAlgorithm__DocumentationAssignment_8_3_1");
					put(grammarAccess.getMdAlgorithmAccess().getCategoryAssignment_8_4_1(), "rule__MdAlgorithm__CategoryAssignment_8_4_1");
					...
					put(grammarAccess.getMdCategoryAccess().getLabelAssignment_4_0_1(), "rule__MdCategory__LabelAssignment_4_0_1");
					put(grammarAccess.getMdCategoryAccess().getDescriptionAssignment_4_1_1(), "rule__MdCategory__DescriptionAssignment_4_1_1");
					put(grammarAccess.getMdCategoryAccess().getDocumentationAssignment_4_2_1(), "rule__MdCategory__DocumentationAssignment_4_2_1");
					put(grammarAccess.getMdOptionSupportAccess().getOptionAssignment_1(), "rule__MdOptionSupport__OptionAssignment_1");
					put(grammarAccess.getMdOptionSupportAccess().getValueAssignment_2_1(), "rule__MdOptionSupport__ValueAssignment_2_1");
					put(grammarAccess.getMdOptionSupportAccess().getDocumentationAssignment_3_1(), "rule__MdOptionSupport__DocumentationAssignment_3_1");
					...
					put(grammarAccess.getMdBundleAccess().getUnorderedGroup_1_2(), "rule__MdBundle__UnorderedGroup_1_2");
					put(grammarAccess.getMdOptionAccess().getUnorderedGroup_6(), "rule__MdOption__UnorderedGroup_6");
					put(grammarAccess.getMdAlgorithmAccess().getUnorderedGroup_8(), "rule__MdAlgorithm__UnorderedGroup_8");
					put(grammarAccess.getMdCategoryAccess().getUnorderedGroup_4(), "rule__MdCategory__UnorderedGroup_4");
				}
			};
		}
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			InternalMetaDataParser typedParser = (InternalMetaDataParser) parser;
			typedParser.entryRuleMdModel();
