		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getMdPropertyTargetTypeAccess().getAlternatives(), "rule__MdPropertyTargetType__Alternatives");
					...
					put(grammarAccess.getMdPropertyAccess().getGroup_6_1(), "rule__MdProperty__Group_6_1__0");
					...
					put(grammarAccess.getMdPropertyAccess().getGroup_6_5(), "rule__MdProperty__Group_6_5__0");
					put(grammarAccess.getMdPropertyAccess().getGroup_6_6(), "rule__MdProperty__Group_6_6__0");
					put(grammarAccess.getMdPropertyAccess().getGroup_6_6_2(), "rule__MdProperty__Group_6_6_2__0");
					put(grammarAccess.getMdPropertyAccess().getGroup_6_7(), "rule__MdProperty__Group_6_7__0");
					put(grammarAccess.getMdPropertyAccess().getGroup_6_7_2(), "rule__MdProperty__Group_6_7_2__0");
					...
					put(grammarAccess.getMdAlgorithmAccess().getGroup_8_5_2(), "rule__MdAlgorithm__Group_8_5_2__0");
					...
					put(grammarAccess.getMdPropertySupportAccess().getGroup(), "rule__MdPropertySupport__Group__0");
					put(grammarAccess.getMdPropertySupportAccess().getGroup_2(), "rule__MdPropertySupport__Group_2__0");
					put(grammarAccess.getMdPropertySupportAccess().getGroup_3(), "rule__MdPropertySupport__Group_3__0");
					...
					put(grammarAccess.getMdPropertyAccess().getOutputAssignment_1_2(), "rule__MdProperty__OutputAssignment_1_2");
					put(grammarAccess.getMdPropertyAccess().getGlobalAssignment_1_3(), "rule__MdProperty__GlobalAssignment_1_3");
					put(grammarAccess.getMdPropertyAccess().getNameAssignment_3(), "rule__MdProperty__NameAssignment_3");
					put(grammarAccess.getMdPropertyAccess().getTypeAssignment_4_1(), "rule__MdProperty__TypeAssignment_4_1");
					put(grammarAccess.getMdPropertyAccess().getLabelAssignment_6_0_1(), "rule__MdProperty__LabelAssignment_6_0_1");
					put(grammarAccess.getMdPropertyAccess().getDescriptionAssignment_6_1_1(), "rule__MdProperty__DescriptionAssignment_6_1_1");
					put(grammarAccess.getMdPropertyAccess().getDocumentationAssignment_6_2_1(), "rule__MdProperty__DocumentationAssignment_6_2_1");
					put(grammarAccess.getMdPropertyAccess().getDefaultValueAssignment_6_3_2(), "rule__MdProperty__DefaultValueAssignment_6_3_2");
					put(grammarAccess.getMdPropertyAccess().getLowerBoundAssignment_6_4_2(), "rule__MdProperty__LowerBoundAssignment_6_4_2");
					put(grammarAccess.getMdPropertyAccess().getUpperBoundAssignment_6_5_2(), "rule__MdProperty__UpperBoundAssignment_6_5_2");
					put(grammarAccess.getMdPropertyAccess().getTargetsAssignment_6_6_1(), "rule__MdProperty__TargetsAssignment_6_6_1");
					put(grammarAccess.getMdPropertyAccess().getTargetsAssignment_6_6_2_1(), "rule__MdProperty__TargetsAssignment_6_6_2_1");
					put(grammarAccess.getMdPropertyAccess().getLegacyIdsAssignment_6_7_1(), "rule__MdProperty__LegacyIdsAssignment_6_7_1");
					put(grammarAccess.getMdPropertyAccess().getLegacyIdsAssignment_6_7_2_1(), "rule__MdProperty__LegacyIdsAssignment_6_7_2_1");
					...
					put(grammarAccess.getMdAlgorithmAccess().getDescriptionAssignment_8_1_1(), "rule__MdAlgorithm__DescriptionAssignment_8_1_1");
					put(grammarAccess.getMdAlgorithmAccess().getDocumentationAssignment_8_2_1(), "rule__MdAlgorithm__DocumentationAssignment_8_2_1");
					put(grammarAccess.getMdAlgorithmAccess().getCategoryAssignment_8_3_1(), "rule__MdAlgorithm__CategoryAssignment_8_3_1");
					put(grammarAccess.getMdAlgorithmAccess().getPreviewImageAssignment_8_4_1(), "rule__MdAlgorithm__PreviewImageAssignment_8_4_1");
					put(grammarAccess.getMdAlgorithmAccess().getSupportedFeaturesAssignment_8_5_1(), "rule__MdAlgorithm__SupportedFeaturesAssignment_8_5_1");
					put(grammarAccess.getMdAlgorithmAccess().getSupportedFeaturesAssignment_8_5_2_1(), "rule__MdAlgorithm__SupportedFeaturesAssignment_8_5_2_1");
					...
					put(grammarAccess.getMdPropertySupportAccess().getPropertyAssignment_1(), "rule__MdPropertySupport__PropertyAssignment_1");
					put(grammarAccess.getMdPropertySupportAccess().getValueAssignment_2_1(), "rule__MdPropertySupport__ValueAssignment_2_1");
					put(grammarAccess.getMdPropertySupportAccess().getDuplicatedAssignment_2_2(), "rule__MdPropertySupport__DuplicatedAssignment_2_2");
					put(grammarAccess.getMdPropertySupportAccess().getDocumentationAssignment_3_1(), "rule__MdPropertySupport__DocumentationAssignment_3_1");
					...
					put(grammarAccess.getMdPropertyAccess().getUnorderedGroup_6(), "rule__MdProperty__UnorderedGroup_6");
